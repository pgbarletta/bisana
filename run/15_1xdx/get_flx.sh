...
ANA2 pdbs/1xdx_13.pdb -c cavidad/cut_acb.cfg -M pdbs/modes_1xdx -Z ${d} > flx_acb_${d}
ANA2 pdbs/1xdx_13.pdb -c cavidad/cut_adb.cfg -M pdbs/modes_1xdx -Z ${d} > flx_adb_${d}
